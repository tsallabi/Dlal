  ...
  return (
    <html lang="ar" dir="rtl">
      ...
      <body class="admin-body">
        <header class="hdr"><div class="hdr-top wrap"><a href="/" class="logo"><img src="/hudhud-logo.svg" alt="" width="77" height="64" /><span class="t"><b>هدهد <em>الصين</em></b><i>HUDHUD</i></span></a><span class="pill">لوحة الإدارة</span>
...
export const PartnerShell: FC<{ user: User; partner: { name: string }; active: string; title: string; children: any; counts?: Record<string, number> }> = ({ user, partner, active, title, children, counts = {} }) => (
  <html lang="ar" dir="rtl">
    ...
    <body class="admin-body">
      <header class="hdr"><div class="hdr-top wrap"><a href="/partner" class="logo"><img src="/hudhud-logo.svg" alt="" width="77" height="64" /><span class="t"><b>هدهد <em>الصين</em></b><i>HUDHUD</i></span></a><span class="pill" style="background:#0b6b66">لوحة الشحن — {partner.name}</span>
