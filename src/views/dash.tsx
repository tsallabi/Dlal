...
export const AdminShell: FC<{ user: User; active: string; title: string; children: any; counts?: Record<string, number> }> = ({ user, active, title, children, counts = {} }) => {
  ...
  const items = [
    ...
    ['الكتالوج', [L('/admin/import', 'import', '⬇️ الاستيراد من 1688', 'catalog.manage'), L('/admin/products', 'products', '🛍️ المنتجات', 'catalog.manage'), L('/admin/categories', 'categories', '🗂️ الأقسام والأوزان', 'catalog.manage'), L('/admin/stock', 'stock', '🔄 فحص المخزون', 'catalog.manage'), L('/admin/crawler', 'crawler', '🤖 الزاحف (إضافة المتصفح)', 'catalog.manage'), L('/admin/api1688', 'api1688', '🔌 ربط API 1688', 'catalog.manage')]],
