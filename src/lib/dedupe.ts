...
const NOISE = [
  ...
  // السنة رقمًا مستقلًا فقط: كانت «20\d\d» تقصّ الأرقام الطويلة من وسطها (رقم الموديل، رقم العرض
  // 690202645884 ⟵ «690» و«45884») فيصير العنوان أربع كلمات ويُحكم عليه «توأمًا» لعنوان لا يشبهه
  /موسم (الخريف|الربيع|الصيف|الشتاء)|خريف|ربيع|صيف|شتاء|(?<!\d)20\d\d(?!\d)/g,
  // صيني
