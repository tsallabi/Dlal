...
// لا نُخفيها — صاحب المشروع طلب التوضيح لا الإخفاء (٢٢/٠٩/٢٦) — بل نشرحها على الرف.
...
export const KIND_NOTE: Record<ListingKind, { tag: string; note: string }> = {
  rack:      { tag: 'حامل عرض', note: 'حامل عرض للمحلات: يصلكِ الحامل وحده فارغًا، والبضاعة الظاهرة في الصورة للتوضيح فقط.' },
  mannequin: { tag: 'مجسّم عرض', note: 'مجسّم عرض (مانيكان) للمحلات: يصلكِ المجسّم وحده، والملابس في الصورة للتوضيح فقط.' },
