/* هدهدي — سكربت الاستيراد. يُحقن في صفحة 1688 عبر bookmarklet.
...
(function () {
  ...
  function ui(items, isDetail) {
    ...
    p.innerHTML = `<div style="background:#B05A20;color:#fff;padding:12px 16px;font-weight:bold;display:flex;justify-content:space-between"><span>هدهدي — استيراد ${items.length} منتج</span><span id="dlal-x" style="cursor:pointer">✕</span></div>
      <div style="padding:10px 16px;border-bottom:1px solid #eee"><label>القسم في هدهدي: <select id="dlal-cat" style="width:100%;padding:6px"></select></label>
