...
| مزوّد API من طرف ثالث (OTAPI / TMAPI) | آلي كليًا من الخادم كل ليلة بلا متصفح، باشتراك مدفوع | `/admin/source` |
المهام نفسها (`crawl_jobs`) تنفذها الإضافة أو الخادم حسب المتاح، والعناوين الصينية تُترجم بالذكاء الاصطناعي عند الاستيراد.
