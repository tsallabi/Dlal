// تالين — ضبط تلقائي: عند فتح لوحة الزاحف في موقع تالين تأخذ الإضافة العنوان والرمز بنفسها
(async function () {
  ...
  if (!token) { banner('إضافة تالين مثبّتة، لكن IMPORT_TOKEN غير مضبوط على الخادم', '#d3262b'); return; }
